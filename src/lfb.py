...
# fd = process_directory(fd)# doesn't wrok
# err = process_directory(err)# doesn't work

# print("[LOG] " + str(len(fd)))
# print("[LOG] " + str(len(err)))
...
f.write("Total number of unaccessible files in " + src_4 + " : " + str(len(err_1)) + "\n")
f.write("Total number of unaccessible files in " + src_5 + " : " + str(len(err_2)) + "\n")
